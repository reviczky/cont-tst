...
제 3 장에서 $\binom{n}{r}$ 혹은 $C_r^n$로 표현되는 많은 수들을 소개하였다. 마지막 세 장들은 이 수들을 \myindex{이항전개식}과 \myindex{파스칼의 삼각형}을 통해 더 다루고 있다. 많은 \myindex{유용한} \myindex{항등식}들이 \myindex{증명}되었고, 또 이 \myindex{항등식}들이 나타나는 의외의 문제들도 제시되었다.
\blank
