...
\definemathfence [scriptbracket] [bracket] [define=yes,color=green,mathstyle=script]
\definemathfence [smallbracket]  [bracket] [define=yes,color=green,mathstyle=small]
\definemathfence [normalbracket] [bracket] [define=yes,color=magenta]
